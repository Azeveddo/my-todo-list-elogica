...
import { exportAll } from './vtodo-google';
...
export class AppComponent implements AfterViewInit {
  ...
  newTaskTitle: string = ''; // For adding tasks
  ...
  async completed(task: tasks_v1.Schema$Task) {
  ...
  async del(task: tasks_v1.Schema$Task) {
    this.selectTask(task)
  ...
  //Chama modal para adicionar tarefa, modal de tag 'dadd'
  addTaskDialog() {
